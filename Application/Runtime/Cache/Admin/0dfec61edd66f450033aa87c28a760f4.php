            ...
            <form action="/index.php?m=admin&c=login&a=dologin" method="post">
                <ul class="admin_items">
                    <li>
                        ...
                        <input type="text" name="uname" value="" autocomplete="Off" id="user" size="40" class="admin_input_style" />
                    </li>
                    <li>
                     ...
                     <li>
                        ...
                        <input type="text" name="code" value="" autocomplete="Off" size="13" class="admin_input_style" />
