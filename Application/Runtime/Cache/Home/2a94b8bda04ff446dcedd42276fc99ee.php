...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="Home/Admin/css/style_1_common.css?gQK" /> 
  <link rel="stylesheet" type="text/css" href="Home/Admin/css/style_1_forum_viewthread.css?gQK" /> 
  <link rel="stylesheet" type="text/css" href="Home/Admin/css/layout.css">
  <link rel="stylesheet" type="text/css" href="Home/Admin/css/css.css">
</head>
<body>
<!--网页顶部start-->
  <div id="top">
	...
	<div id="main">
		...
		<div id="header">
		  ...
		  <div id="logo_login">
			...
			<form action="/index.php?m=home&c=login&a=dologin" method="POST">
			  <table>
				...
				<tr>
				  ...
				  <td>
					<a href="/index.php?m=home&c=login&a=signup">
					立即注册
					</a>
				  </td>
				</tr>
			...
			<table>
				<tr>
					<td>
						用户:<a href="/index.php?m=home&c=login&a=edit&uid=<?=$_SESSION['userInfo']['uid'] ?>"><?=$_SESSION['userInfo']['uname']?></a>
					</td>
					<td>
				...
				<td>
					<a href="/index.php?m=home&c=index&a=index">返回首页</a>
				</td>
			</table>
			<?php endif; ?>
			</div>
		...
		<div class="content">		
            ...
            <div class="section">
                ...
                <!--分区内容部分start-->
                <?php foreach($part['sub'] as $k=>$v): ?>
                <div class="section_content">
                  <table cellspacing="0" celpadding="0">
                    <tr>
                      <td width="33%">
                        <span class="section_content_ico">
                          <img src="/Home/Admin/images/forum_new.gif" title="Discuz!程序发布" />
                        </span>
                        <dl>
                          <dd class="dd_title"><a href='/index.php?m=home&c=post&a=index&cid=<?=$v['cid'] ?>'><?=$v['cname'] ?></a></dd>
     ...
     <!--友情链接部分start-->
        <div id="friend_link">
            ...
            <div class="fri_content">
                <div class="fri_left"><img src="/Home/Admin/images/20080926_9b2baec56b95a9ae46ab8ir8uBrEJQjx.gif" /></div>
                <div class="fri_right">
