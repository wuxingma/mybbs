			...
			<form action="/index.php?m=home&c=login&a=register" method="post">
				<table align="center" width="300" height="60">
					...
					<tr>
						...
						<td>
							<select name="sex">
								<option value="<?php if($users['sex']=='w'){echo 'selected';} ?>">女</option>
								<option value="<?php if($users['sex']=='m'){echo 'selected';} ?>">男</option>
								<option value="<?php if($users['sex']=='x'){echo 'selected';} ?>">保密</option>
							</select>
						</td>
					</tr>
					<tr>
