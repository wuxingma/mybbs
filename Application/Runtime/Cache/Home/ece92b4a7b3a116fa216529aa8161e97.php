...
<!--网页顶部end-->
	...
	<!--内容部分start-->
		<div class="content">			
			...
			<div class="send_btn">
				<div class="send">
					<a href="/index.php?m=home&c=post&a=create">
						<img src="/Home/Admin/images/pn_post.png" />
					</a>
				</div>
				...
				<div class="post_content">
					<table cellspacing=0 cellpadding=0 width='100%'>
						...
						<tr>
							...
							<td class="list_ptime"><?=date('Y-m-d H:i:s',$post['created_at']) ?></td>
						</tr>
						<?php endforeach; ?>
					</table>
				</div>
